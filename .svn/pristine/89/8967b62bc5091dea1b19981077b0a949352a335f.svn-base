        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                	<span id="date" class="px-4 py-2 fs-5"></span>
                	<div class="d-flex">
	                	...
	                	<div class="p-2 flex-fill">
	                		<select class="form-select" id="selectDept" aria-label="Default select example">
        ...
        $.ajax({
            ...
            success: function(res) {
            	...
            	for(var i = 0; i < res.dataList.length; i++){
            		html += "<tr>";
            		html += "<td><a href='/work/workdetail?empNo=" + res.dataList[i].empNo + "&firstDate=" + firstDate + "&lastDate=" + lastDate + "'>" + res.dataList[i].empName + "</a></td>";
