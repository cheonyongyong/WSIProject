						...
						<div class="row">
							...
							<div class="col-md-4">
								<div style="padding: 30px;">
									...
									<p class="fw-bold px-4 py-2 fs-6">${emp.empReg1 }-${emp.empReg2 }</p>
									...
									<p class="fw-bold px-4 py-2 fs-6">${emp.empAddr1 }
										${emp.empAddr2 }</p>
									<p class="fw-bold px-4 py-2 fs-6">${emp.empBank }
										${emp.empAcct }</p>
								</div>
							</div>
							<div class="col-md-1 ms-auto">
