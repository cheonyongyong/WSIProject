		...
		<div class="card">
			<div class="card-body">
				<div class="row" style="padding-top: 15px;">			
					...
					<!-- end col -->
					<div class="col-md-6">
						<div class="d-flex flex-wrap align-items-center justify-content-md-end mt-2 mt-md-0 gap-2 mb-3">
							<div class="d-flex flex-wrap align-items-center justify-content-md-end">
								<div class="row d-flex flex-wrap align-items-center justify-content-md-end" style="text-align: right; font-weight: normal; margin-right: 10px; width: 300px;">
									...
									<select class="form-select" style="width: 85px;" id="month">
										<option><fmt:formatDate value="${today}" pattern="MM" /></option>
										<c:forEach begin="1" end="4" var="idx" step="1">
								...
								<div class="d-flex flex-wrap align-items-center justify-content-md-end" style="background-color: rgba(245, 246, 248, 0.25);">
									<input type="text" name="searchWord" id="searchWord" placeholder="  사원이름, 부서 검색" style="height: 33px;"/>
...
// 		console.log(month);
	...
	grid.on("click",ev => {
		...
		document.getElementById('empMonth').innerHTML = month;
