													...
													<c:forEach items="${mhr1List }" var="hr">
														<tr class="gridjs-tr">
															...
															<td data-column-id="empStat" class="gridjs-td">
																<div class="d-flex gap-2">
																	<c:if test="${hr.empStat eq '재직중' }">
																		<div class="badge badge-soft-primary">${hr.empStat }</div>
																	</c:if>
																	<c:if test="${hr.empStat eq '휴가중' }">
																		<div class="badge badge-soft-warning">${hr.empStat }</div>
																	</c:if>
																	<c:if test="${hr.empStat eq '수습중' }">
																		<div class="badge badge-soft-success">${hr.empStat }</div>
																	</c:if>
																	<c:if test="${hr.empStat eq '퇴직예정' }">
																		<div class="badge badge-soft-purple">${hr.empStat }</div>
																	</c:if>
																	<c:if test="${hr.empStat eq '퇴직완료' }">
																		<div class="badge badge-soft-secondary">${hr.empStat }</div>
																	</c:if>
																</div>
															</td>
															...
															<td data-column-id="empWork" class="gridjs-td">
																<div class="d-flex gap-2">
																	<div class="badge badge-soft-primary">${hr.empWork }</div>
																</div>
															</td>
														</tr>
													</c:forEach>
      ...
      success: function (response) {
        ...
        for(let i = 0; i<response.length; i++) {
          ...
          function badge(empStat) {
              switch (empStat) {
                  case '재직중':
                      return '<div class="badge badge-soft-primary">' + empStat + '</div>';
                  case '휴가중':
                      return '<div class="badge badge-soft-warning">' + empStat + '</div>';
                  case '수습중':
                      return '<div class="badge badge-soft-success">' + empStat + '</div>';
                  case '퇴직예정':
                      return '<div class="badge badge-soft-purple">' + empStat + '</div>';
                  case '퇴직완료':
                      return '<div class="badge badge-soft-secondary">' + empStat + '</div>';
                  default:
                      return empStat;
              }
          }
