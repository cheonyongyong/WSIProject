...
<div class="card">
	<div class="card-body">
		<div class="row">
			<div class="col-1">
				<select id="yearSelect" class="form-select" aria-label="Default select example" style="width:200px; margin-bottom: 13px;">
					...
					<option value="2023" selected>2023</option><!-- 기본 선택: 현재 연도 -->
				</select>
			</div>
