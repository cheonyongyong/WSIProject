		...
		<div class="card">
			<div class="card-body">
				<div class="row">
					<div class="col-md-6">
						<div class="d-flex flex-wrap gap-2 mt-2 mt-md-0 mb-3">
							<span class="font-size-20 mb-1">
								...
								<fmt:formatDate value="${today}" pattern="yyyy년 MM"/>월 정산 관리
							</span>
						</div>
					</div>
					<!-- end col -->
					...
					<div class="col-md-6">
						<div class="d-flex flex-wrap align-items-center justify-content-md-end mt-2 mt-md-0 gap-2 mb-3" style="background-color: rgba(245, 246, 248, 0.25);">
							...
							<button class="btn btn-primary" id="startInCal">
								정산하기
							</button>
						</div>
					</div><!-- end col -->
