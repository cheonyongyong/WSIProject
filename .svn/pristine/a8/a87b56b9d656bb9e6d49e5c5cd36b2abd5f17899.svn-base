	            ...
	            <div class="card-body">
	                <div class="d-flex align-items-start mb-4">
	                    ...
	                    <div class="flex-grow-1">
	                        ...
	                        <small class="text-muted">${board.boardRegdate }</small>
	                    </div>
	                </div>
					<hr>
...
<%-- 	                            <img class="card-img-top img-fluid" src="${pageContext.request.contextPath }/resources/assets/images/small/img-3.jpg" alt="Card image cap"> --%>
...
<!-- 	                    <div class="col-xl-2 col-6"> -->
<!-- 	                        <div class="card border shadow-none"> -->
<%-- 	                            <img class="card-img-top img-fluid" src="${pageContext.request.contextPath }/resources/assets/images/small/img-4.jpg" alt="Card image cap"> --%>
<!-- 	                            <div class="py-2 text-center"> -->
<!-- 	                                <a href="#!" class="fw-semibold font-size-13 text-reset">Download <i class="bx bxs-download align-middle"></i></a> -->
<!-- 	                            </div> -->
<!-- 	                        </div> -->
