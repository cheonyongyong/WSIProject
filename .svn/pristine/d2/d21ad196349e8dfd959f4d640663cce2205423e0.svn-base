	...
	<div id="pdfDiv">
		<div class="modal-content" style="width: 1000px;">
			...
			<div class="modal-body" style="padding-top: 0px;">
				...
				<table border="3px solid black;" style="width: 80%; position: relative; margin: auto;">
					<thead style="border: 2px solid black; background-color: #e3e4e5;">
						<tr>
