...
//			MenuVO menu2 = new MenuVO("구성원 휴가", "/vacation/teamvacationlist");
//			menuList = Arrays.asList(menu1, menu2);
//		} else {
//			MenuVO menu2 = new MenuVO("나의 팀 휴가", "/vacation/myteamvacation");
//			menuList = Arrays.asList(menu1, menu2);
//		}
//				
//		model.addAttribute("menuList", menuList);
...
//		// 서브메뉴 리스트
//		MenuVO menu4 = new MenuVO("휴가 신청", "/vacation/vacationapply");
//		MenuVO menu5 = new MenuVO("연차 상세", "/vacation/annuallist");
//		List<MenuVO> submenuList = Arrays.asList(menu4, menu5);
//		model.addAttribute("submenuList", submenuList);
//		
//		// 현재 주소 보내주기
...
/////////데이터 가져오기////////////////////		
	...
	public String annualList(Model model, HttpServletRequest request) {
		...
		// 메인메뉴 리스트
		MenuVO menu1 = new MenuVO("연차 상세", "/vacation/annuallist");
		List<MenuVO> menuList = Arrays.asList(menu1);
		model.addAttribute("menuList", menuList);
//		// 시큐리티에 담긴 로그인된 유저 정보
//		CustomUser user = (CustomUser)SecurityContextHolder.getContext().getAuthentication().getPrincipal(); 
...
//		request.setAttribute("currentURL", currentURL);
	...
	public String teamVacationList(
		...
		// 메인메뉴 리스트
		MenuVO menu1 = new MenuVO("휴가 보유 현황", "/vacation/teamvacationlist");
		List<MenuVO> menuList = Arrays.asList(menu1);
		model.addAttribute("menuList", menuList);
//		// 시큐리티에 담긴 로그인된 유저 정보
//		CustomUser user = (CustomUser)SecurityContextHolder.getContext().getAuthentication().getPrincipal(); 
...
//		
//		if(auth.equals("ROLE_ADMIN") || auth.equals("ROLE_MANAGER")) {
//			MenuVO menu4 = new MenuVO("휴가 보유 현황", "/vacation/teamvacationlist");
//			MenuVO menu5 = new MenuVO("휴가 사용 내역", "/vacation/teamvacationusinglist");
//			MenuVO menu6 = new MenuVO("연차 관리", "/vacation/annualmanage");
//			submenuList = Arrays.asList(menu4, menu5, menu6);
//		} else {
//			MenuVO menu3 = new MenuVO("팀원 휴가 보유 현황", "/vacation/myteamvacation");
//			submenuList = Arrays.asList(menu3);
//		}
//
//		model.addAttribute("submenuList", submenuList);
//		
...
//###############################################################################################################################		
	 ...
	 */
	@PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_MANAGER', 'ROLE_MEMBER')")
	@RequestMapping(value = "/myteamvacation", method = RequestMethod.GET)
	public String myTeamVacation(Model model, HttpServletRequest request) {
		log.info("myTeamVacation() 실행!!!!!!");
...
//////////////////////////////////////////////////////////		
		...
		List<VacationPersonalVO> haveVacList = vacService.haveVacList();
		model.addAttribute("haveVacList", haveVacList);
	...
	public String teamVacationUsingList(Model model, HttpServletRequest request) {
		...
		// 메인메뉴 리스트
		MenuVO menu1 = new MenuVO("휴가 사용 내역", "/vacation/teamvacationusinglist");
//		MenuVO menu2 = new MenuVO("구성원 휴가", "/vacation/teamvacationlist");
		List<MenuVO> menuList = Arrays.asList(menu1);
		model.addAttribute("menuList", menuList);
//		
...
//##############################################################################################	
	...
	public String teamAnnualManage(
		...
		// 메인메뉴 리스트
		MenuVO menu1 = new MenuVO("연차 관리", "/vacation/annualmanage");
//		MenuVO menu2 = new MenuVO("구성원 휴가", "/vacation/teamvacationlist");
		List<MenuVO> menuList = Arrays.asList(menu1);
		model.addAttribute("menuList", menuList);
//		
...
//	@ResponseBody
//	@RequestMapping(value = "/annualmanage", method = RequestMethod.POST)
//	public List<VacationPersonalVO> annualManage(@RequestBody Map<String, String> map) {
//		
//		String year = map.get("year").toString();
//		log.info("선택연도!!! {} ", year);
//		
//		List<VacationPersonalVO> annualManageList = vacService.annualManageList(map);
//		
//		return annualManageList;
//	}
