...
<!-- 							</div> -->
							...
							<!-- 파일 업로드 -->
<!-- 			                <div> -->
<!-- 			                    <form action="/notice/register" class="dropzone file"> -->
<!-- 			                        <div class="fallback"> -->
<!-- 			                            <input id="boFile" name="boFile" type="file" multiple="multiple"> -->
<!-- 			                        </div> -->
...
<%-- 							<c:if test="${not empty board.noticeFileList }"> --%>
<%-- 								<c:forEach items="${board.noticeFileList }" var="noticeFile" varStatus="vs"> --%>
<!-- 									<li> -->
