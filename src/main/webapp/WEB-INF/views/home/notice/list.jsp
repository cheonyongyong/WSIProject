				...
				<div class="col-md-9">
					<div class="d-flex justify-content-end">
						...
						<div class="search" >
							...
							<button style="margin-bottom: 4px; margin-right: 80px;" type="submit" class="btn btn-soft-primary">검색</button>
						</div>
						<sec:csrfInput/>
					</div>
				</div>
...
<%-- 													<span class="text-dark text-xs font-weight-bold">${board.boardRegdate }</span> --%>
												</td>
<!-- 												<td> -->
...
<!--                         </tr> -->
			...
			<div class="card-body">
			    <nav aria-label="...">
			    	<div class="d-flex justify-content-end">
			    		<button style="margin-right: 80px;" type="button" id="regBtn" class="btn btn-soft-primary" onclick="javascript:location.href='/notice/register'"><i class="uil uil-pen me-2"></i>글쓰기</button>
			    	</div>
