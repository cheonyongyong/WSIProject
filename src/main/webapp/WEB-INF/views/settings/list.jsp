																	...
																	<div class="card-body d-flex flex-wrap align-items-center justify-content-md-center" style="padding: 10px;">
																		<table style="width: 85%;">
																			...
																			<tr>
																				<td>비밀번호</td>
																				<td>
																					<input type="password" class="form-control" name="cusPw" id="cusPw" required="required" maxlength="16" placeholder="비밀번호를 입력해주세요." readonly="readonly">
																				</td>
																			</tr>
																			<tr>
																				<td>비밀번호 확인</td>
																				<td>
																					<input type="password" class="form-control" name="cusPw2" id="cusPw2" required="required" maxlength="16" placeholder="비밀번호를 다시 입력해주세요." readonly="readonly">
																				</td>
																			</tr>
																			<tr>
																				<td>대표자</td>
											...
											<div class="accordion-body">
												<ul class="list-unstyled mb-0">
													<ul>
														...
														<li><a href="" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRightDefault" aria-controls="offcanvasRight">기본 그룹 권한 설정</a></li>
														<li><a href="" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRightCustom" aria-controls="offcanvasRight">맞춤 그룹 권한 설정</a></li>
													</ul>
												</ul>
																	 ...
																	 <form id="frm" method="POST" enctype="multipart/form-data">
																		 <table>
																		 	...
																		 	<tr>
																		 		...
																		 		<td width="20%;">
																					<button class="d-flex flex-wrap" type="button" id="uploadBtn">제출</button>
																				</td>
																		 	</tr>
																		</table>
												        			</form>
												...
												<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRightDefault" aria-labelledby="offcanvasRightLabel" style="background-color: #e6f4fc; width: 40%">
													...
													<div class="offcanvas-body" style="padding-top: 0px; padding-bottom: 10px;">
														...
														<div class="card-body" style="background-color: white; border-radius: 5px;">
															...
															<div class="row">
																<div class="d-flex flex-wrap align-items-end justify-content-md-end">
																	<button type="button" class="btn btn-primary d-flex align-items-end" id="">저장하기</button>	
																</div>
															</div>
														</div>
													</div>
