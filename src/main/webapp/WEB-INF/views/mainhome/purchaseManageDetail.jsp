    ...
    <div class="row" style="margin: 0; padding: 0;">
        ...
        <div>
	        <table class="table col-lg-10">
	        	...
	        	<tr>
	        		<th>선택한 레벨</th>
	        		<td>${customerVO.paymentVO.levelName }(${customerVO.paymentVO.levelMemo })</td>
	        	</tr>
	        	<tr>
	        		<th>자료실 용량</th>
	        		<td>
			        	<fmt:formatNumber value="${customerVO.paymentVO.levelVol }" pattern="#,###" />MB
	        		</td>
	        	</tr>
	        	<tr>
	        		<th>선택한 기능</th>
...
$(function() {
	...
	updateBtn.on("click", function() {
		...
		levelForm.attr("action", "/mypageadmin/purchaseupdate");
		levelForm.submit();
	})
