...
$(function() {
=======
															<i class="far fa-bookmark bookmark11" id="bookmark"></i>
															<a href="#" class="dropdown-toggle font-size-16 text-muted" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																<i class="uil-cog"></i>
															</a>
															<div class="dropdown-menu dropdown-menu-end" style="padding: 10px;">
										...
										<div class="card task-box">
											<div class="card-body">
												<div class="d-flex align-items-start mb-2 gap-2">
													<div class="flex-grow-1">
														<span class="btn btn-light btn-sm badge badge-soft-primary">근로소득</span>
														<span class="btn btn-light btn-sm badge badge-soft-dark">지급일 26일 전</span>
													</div>
													<div class="flex-shrink-0 ms-2">
														<div class="dropdown">
															<i class="fas fa-bookmark" id="bookmark" style="color: red;"></i>
															<a href="#" class="dropdown-toggle font-size-16 text-muted" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																<i class="uil-cog"></i>
															</a>
															<div class="dropdown-menu dropdown-menu-end" style="padding: 10px;">
									...
									<div class="card task-box">
											<div class="card-body">
												<div class="d-flex align-items-start mb-2 gap-2">
													...
													<div class="flex-shrink-0 ms-2">
														<div class="dropdown">
															<i class="far fa-bookmark" id="bookmark2"></i>
															<a href="#" class="dropdown-toggle font-size-16 text-muted" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																<i class="uil-cog"></i>
															</a>
															<div class="dropdown-menu dropdown-menu-end" style="padding: 10px;">
										...
										<div class="card task-box">
											<div class="card-body">
												<div class="d-flex align-items-start mb-2 gap-2">
													...
													<div class="flex-shrink-0 ms-2">
														<div class="dropdown">
															<i class="far fa-bookmark bookmark11" id="bookmark3"></i>
															<a href="#" class="dropdown-toggle font-size-16 text-muted" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																<i class="uil-cog"></i>
															</a>
															<div class="dropdown-menu dropdown-menu-end" style="padding: 10px;">
...
// 		if(bookmark.css("color", "red")){
// // 		if(bookmark.css("color") = "red"){
// 			bookmark.attr("class", "far fa-bookmark");
// 			bookmark.removeAttr("color");
// 		}
	});
	var bookmark2 = $("#bookmark2");
	bookmark2.on("click", function() {
		bookmark2.attr("class", "fas fa-bookmark");
		bookmark2.css("color", "red");
		Swal.fire({
	        title: "즐겨찾기에 추가되었습니다.",
	        confirmButtonColor: "#038edc"
	    });
	...
	bookmark3.on("click", function() {
		bookmark3.attr("class", "fas fa-bookmark");
		bookmark3.css("color", "red");
		Swal.fire({
	        title: "즐겨찾기에 추가되었습니다.",
	        confirmButtonColor: "#038edc"
	    });
