                ...
                <div class="col-lg-10">
                        ...
                        <div class="py-5">
                                        ...
                                        <div class="p-4 p-lg-5 bg-primary h-100 d-flex align-items-center justify-content-center">
                                            <div class="w-100">
                                                ...
                                                <div class="text-white-50 mb-4">
                                                    <h5 class="text-white">비밀번호 재설정</h5>
                                                ...
                                                <form action="/resetpw" method="post" id="resetForm" >
                                                    ...
                                                    <div class="mt-4">
                                                        <button class="btn btn-info w-100" type="button" id="resetPw">재설정</button>
                                                    </div>
                                                    <sec:csrfInput/>
                                                </form><!-- end form -->
                                            </div>
                            ...
                            <div class="mt-5 text-center text-muted">
                                <p>비밀번호가 기억 나시나요 ? <a href="auth-signin-cover.html" class="fw-medium text-decoration-underline"> 로그인 </a></p>
                            </div>
                        </div>
