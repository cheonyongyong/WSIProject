...
$(function(){
	...
	$.ajax({
		...
		success : function(result){
			...
			infomodal += "<div class='modal-footer'>";
			infomodal += "<button type='button' class='btn btn-light' data-bs-dismiss='modal'>취소</button>";
			infomodal += "<button type='button' class='btn btn-primary' id='infoModifyBtn'>수정</button>";
			infomodal += "</div>";
			infomodal += "</div>";
			infomodal += "</div>";
			infomodal += "</div>";
			...
			if(famCount == 0){
				...
				for(let i = 0; i < famCount; i++){
					...
					html += "<div class='modal-footer'>";
					html += "<button type='button' class='btn btn-light' data-bs-dismiss='modal'>취소</button>";
					html += "<button type='button' class='btn btn-primary' onclick=\"fn_fammod('"+result.famList[i].efNo+"')\">수정</button>";
					html += "</div>";
					html += "</div>";
					html += "</div>";
					html += "</div>";
			...
			if(carrCount == 0){
				...
				for(let i = 0; i < carrCount; i++){
					...
					carrInfo += "<div class='modal-footer'>";
					carrInfo += "<button type='button' class='btn btn-light' data-bs-dismiss='modal'>취소</button>";
					carrInfo += "<button type='button' class='btn btn-primary' onclick=\"javascript:fn_carrmod('"+result.carrList[i].caNo+"')\">수정</button>";
					carrInfo += "</div>";
					carrInfo += "</div>";
					carrInfo += "</div>";
					carrInfo += "</div>";
			...
			if(acadCount == 0){
				...
				for(let i = 0; i < acadCount; i++){
					...
					acadHtml += "<div class='modal-footer'>";
					acadHtml += "<button type='button' class='btn btn-light' data-bs-dismiss='modal'>취소</button>";
					acadHtml += "<button type='button' class='btn btn-primary' onclick=\"javascript:fn_acadmod('"+result.acadList[i].acadNo+"')\">수정</button>";
					acadHtml += "</div>";
					acadHtml += "</div>";
					acadHtml += "</div>";
					acadHtml += "</div>";
