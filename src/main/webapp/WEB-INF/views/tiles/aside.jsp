...
<!-- 				                            <i class="icon nav-icon" data-feather="home"></i> -->
				                        ...
				                        <ul class="sub-menu" aria-expanded="true">
				                            ...
				                            <li><a href="javascript: void(0);" class="has-arrow" data-key="t-level-1.1">피드</a>
				                            	<ul class="sub-menu" aria-expanded="true">
				                                    <li><a href="/home/feed" data-key="t-level-2.1">메인</a></li>
				                                    <li><a href="/home/schedule" data-key="t-level-2.2">일정</a></li>
				                                </ul>
				                            </li>
				                            
				                            <li><a href="javascript: void(0);" class="has-arrow" data-key="t-level-1.2">회사소식</a>
				                                <ul class="sub-menu" aria-expanded="true">
				                                    <li><a href="/notice/list" data-key="t-level-2.1">공지사항</a></li>
				                                </ul>
				                            </li>
				                            </sec:authorize>
				                        </ul>
									...
									<li class="">
										...
										<ul class="sub-menu mm-collapse" aria-expanded="false" style="">
											...
											<sec:authorize access="hasAnyRole('ROLE_MANAGER','ROLE_ADMIN')">
												<li><a href="/document/alldoclist" data-key="t-document-alldoclist">전체기안문서</a></li>
												<li><a href="/document/updatedoc" data-key="t-document-updatedoc">결재기안</a></li>
									...
									<li class="">
										...
										<ul class="sub-menu mm-collapse" aria-expanded="false" style="">
											...
											<sec:authorize access="hasAnyRole('ROLE_MANAGER','ROLE_ADMIN')">
												...
												<li><a href="/work/workmanagelist" data-key="t-work-workmanagelist">근무 조회</a></li>
												<li><a href="/work/workmanage" data-key="t-work-workmanage">근무 관리</a></li>
											</sec:authorize>
										</ul>
									</li>
									...
									<li class="">
										...
										<ul class="sub-menu mm-collapse" aria-expanded="false" style="">
											...
											<sec:authorize access="hasAnyRole('ROLE_MANAGER','ROLE_ADMIN')">
												<li><a href="/pay/home" class="has-arrow" data-key="t-pay-home" aria-expanded="false">정산 선택</a>
													<ul class="sub-menu mm-collapse" aria-expanded="true">
									...
									<li class="">
										...
										<ul class="sub-menu mm-collapse" aria-expanded="false" style="">
											<li><a href="/vacation/vacationapply" data-key="t-vacation-vacationapply">나의 휴가</a></li>
											<li><a href="/vacation/annuallist" data-key="t-vacation-annuallist">연차 상세</a></li>
											<sec:authorize access="hasRole('ROLE_MEMBER')">
												<li><a href="/vacation/myteamvacation" data-key="t-vacation-myteamvacation">우리 팀 휴가 보유 현황</a></li>
											</sec:authorize>
											<sec:authorize access="hasAnyRole('ROLE_MANAGER','ROLE_ADMIN')">
												<li><a href="/vacation/teamvacationlist" data-key="t-vacation-teamvacationlist">휴가 보유 현황</a></li>
												<li><a href="/vacation/teamvacationusinglist" data-key="t-vacation-teamvacationlist">휴가 사용 내역</a></li>
												<li><a href="/vacation/annualmanage" data-key="t-vacation-annualmanage">연차 관리</a></li>
											</sec:authorize>
										</ul>
									</li>
									...
									<li class="">
										...
										<ul class="sub-menu mm-collapse" aria-expanded="false" style="">
											...
											<sec:authorize access="hasAnyRole('ROLE_MANAGER','ROLE_ADMIN')">
												...
												<li><a href="/library/libraliydata" data-key="t-library-libraliydata">자료등록</a></li>
											</sec:authorize>
										</ul>
									</li>
...
<!-- 									<li><a href="layouts-horizontal.html"> <svg -->
<!-- 												xmlns="http://www.w3.org/2000/svg" width="24" height="24" -->
<!-- 												viewBox="0 0 24 24" fill="none" stroke="currentColor" -->
<!-- 												stroke-width="2" stroke-linecap="round" -->
<!-- 												stroke-linejoin="round" -->
<!-- 												class="feather feather-layout icon nav-icon"> -->
<!-- 												<rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect> -->
<!-- 												<line x1="3" y1="9" x2="21" y2="9"></line> -->
<!-- 												<line x1="9" y1="21" x2="9" y2="9"></line></svg> <span -->
<!-- 											class="menu-item" data-key="t-horizontal">Horizontal</span> -->
<!-- 									</a></li> -->
...
<!-- 						<input class="transparent-focus" style="width: 590px; height: 35px; margin-top: 1px;" type="text" id="empsearchForm" name="empsearchForm" placeholder="구성원 검색" autocomplete="off"/> -->
<!-- 				<div id="empList"></div> -->
<!-- 					</div> -->
<!-- 				</div>/.modal-content -->
